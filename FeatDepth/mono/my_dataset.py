...
class MyDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        self.filenames = filenames  # sorted(os.listdir(data_path))
        self.height = height
        self.width = width
        ...
        self.K = np.array([[1998.7356/1920, 0, 851.8287/1920, 0],
                           [0, 1991.8909/1080, 424.0041/1080, 0],
                           [0, 0, 1, 0],
    ...
    def __getitem__(self, index):
        ...
        for i in self.frame_idxs:
            try:
                filename = self.filenames[index+i]  # 如果是第一张或者最后一张，frame_id = -1 或者 1 会失效
            except:
                filename = self.filenames[index]   # 所以还是选择同一张图片

            newfilename = os.path.join(self.data_path, filename)
