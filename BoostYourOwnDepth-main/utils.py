...
def test_Rx():
    img_path = '/home/tata/Project/dataset/my_dataset/image_undistort/1621586141669855.jpg'
    img = cv2.imread(img_path)
    basesize = 300

    R20_resolution = calculateprocessingres(img, basesize, confidence=0.2, scale_threshold=3, whole_size_threshold=3000)
    print(R20_resolution)
